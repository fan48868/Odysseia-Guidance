...
EMOJI_MAPPINGS = [
    (re.compile(r"\<开心\>"), ["<:kai_xin:1471766600205205655>"]),
    (re.compile(r"\<乖巧\>"), ["<:guai_qiao:1471766428565639281>"]),
    (re.compile(r"\<desuwa\>"), ["<:biao_shi:1471759394151731304>"]),
    (re.compile(r"\<伤心\>"), ["<:shang_xin:1471766631981121568>"]),
    (re.compile(r"\<生气\>"), ["<:sheng_qi:1471766571926945998>"]),
    (re.compile(r"\<加油\>"), ["<:jia_you:1471766542357106823>"]),
    (re.compile(r"\<好奇\>"), ["<:hao_qi:1471766512858697748>"]),
    (re.compile(r"\<邀请\>"), ["<:yao_qing:1471766484895137803>"]),
    (re.compile(r"\<傲娇\>"), ["<:ao_jiao:1471766459020480522>"]),
    (re.compile(r"\<祝福\>"), ["<:zhu_fu:1471766393945849929>"]),
    (re.compile(r"\<你好\>"), ["<:ni_hao:1471766354632773867>"]),
    (re.compile(r"\<叹气\>"), ["<:tan_qi:1471766292301086826>"]),
    (re.compile(r"\<投降\>"), ["<:touxiang:1468959892076494889>"]),
    (re.compile(r"\<比心\>"), ["<:bi_xin:1471776633181704192>"]),
    (re.compile(r"\<偷笑\>"), ["<:tou_xiao:1471930795412426843>"]),
]
